...
const ShiftActionDialog = ({ open, date, shiftType, members, isSelfScheduled, onClose, onAssign, onCancel, onRequestSwap}) => {
    ...
    <div className="dialog-overlay">
        <div className="dialog-box">
            <h3>{date} {shiftType === "MORNING" ? "早班" : "晚班"}</h3>
            <ShiftMemberList members = {members} selectedId={ swapTargetId } onSelect={setSwapTargetId} />
            ...
            <div className="dialog-actions">
                ...
                {isSelfScheduled && (
                    <button onClick={handleCancel}>取消排班</button>
                )}
